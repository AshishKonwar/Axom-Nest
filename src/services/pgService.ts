...
const MOCK_PGS: PG[] = [
  // {
  //   id: "pg-001",
  //   title: "Brahmaputra Premium PG",
  //   description: "A premium paying guest accommodation near Guwahati Railway Station. Fully furnished rooms with all amenities. Ideal for working professionals and students.",
  //   rent: 8500,
  //   location: "Ulubari, Guwahati",
  //   city: "Guwahati",
  //   address: "12, Ulubari Road, Near GS Road, Guwahati - 781007",
  //   gender: "Boys",
  //   images: [PG_IMAGES.room1, PG_IMAGES.room4, PG_IMAGES.room7],
  //   amenities: ["WiFi", "AC", "Food", "Cleaning", "24/7 Security", "CCTV"],
  //   food: true,
  //   wifi: true,
  //   parking: true,
  //   ac: true,
  ...
  //   owner: { name: "Rajiv Sharma", phone: "+91 98765 43210" },
  //   nearbyPlaces: ["Guwahati Railway Station (1.2 km)", "GS Road Mall (0.8 km)", "Cotton University (2.5 km)"],
  //   rules: ["No smoking", "No alcohol", "Gate closes at 11 PM", "No outside guests overnight"],
  // },
  // {
  //   id: "pg-002",
  //   title: "Dispur Heights Ladies PG",
  //   description: "Exclusively for women, located in the heart of Dispur. Safe and secure environment with CCTV surveillance. Walking distance from government offices.",
  //   rent: 9500,
  //   location: "Dispur, Guwahati",
  //   city: "Guwahati",
  //   address: "45, Dispur Colony, Near Assam Secretariat, Guwahati - 781006",
  //   gender: "Girls",
  //   images: [PG_IMAGES.room2, PG_IMAGES.room5, PG_IMAGES.room8],
  //   amenities: ["WiFi", "AC", "Food", "Laundry", "24/7 Security", "CCTV", "Gym"],
  //   food: true,
  //   wifi: true,
  //   parking: false,
  //   ac: true,
  ...
  //   owner: { name: "Priya Devi", phone: "+91 87654 32109" },
  //   nearbyPlaces: ["Assam Secretariat (0.3 km)", "Dispur Hospital (1 km)", "Guwahati High Court (1.5 km)"],
  //   rules: ["Ladies only", "No male guests", "Gate closes at 10 PM", "No cooking in rooms"],
  // },
  {
    id: "pg-003",
    ...
    owner: { name: "Bimal Kalita", phone: "+91 76543 21098" },
  ...
  },
  {
    ...
    featured: true,
    occupancy: ["Single"],
    owner: { name: "Deepak Borah", phone: "+91 65432 10987" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Single", "Double", "Triple"],
    owner: { name: "Hemanta Gogoi", phone: "+91 54321 09876" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Double", "Triple"],
    owner: { name: "Manash Phukan", phone: "+91 43210 98765" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Single", "Double"],
    owner: { name: "Rupali Nath", phone: "+91 32109 87654" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Single", "Double"],
    owner: { name: "Sanjay Das", phone: "+91 21098 76543" },
  ...
  },
  {
    ...
    featured: true,
    occupancy: ["Single", "Double"],
    owner: { name: "Kamal Baruah", phone: "+91 10987 65432" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Double", "Triple"],
    owner: { name: "Anita Saikia", phone: "+91 09876 54321" },
  ...
  },
  {
    ...
    featured: false,
    occupancy: ["Single", "Double", "Triple"],
    owner: { name: "Lakhi Borah", phone: "+91 98765 12345" },
  ...
  },
  {
    ...
    featured: true,
    occupancy: ["Single"],
    owner: { name: "Probal Bordoloi", phone: "+91 87654 67890" },
